...
export const metadata: Metadata = {
  title: "Sofia di Bella | Premium Insurance Solutions",
  description: "Expert insurance planning and financial security strategies from Sofia di Bella. Multilingual international experience serving clients worldwide.",
  keywords: "insurance, financial planning, wealth management, international insurance, Sofia di Bella",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765122546565-o5yurpe8.jpg",
        alt: "Sofia di Bella Insurance Services",
      },
    ],
  },
  twitter: {
    ...
    title: "Sofia di Bella | Premium Insurance Solutions",
    description: "Expert insurance planning and financial security strategies from Sofia di Bella.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765122546565-o5yurpe8.jpg"],
  },
};
